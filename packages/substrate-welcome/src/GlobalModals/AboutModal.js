    ...
    return (
      ...
      >
        <div className='d-flex flex-column align-items-center justify-content-center'>
          ...
          <p className='mt-3'><span className='h4'><b>Substrate IDE</b></span> v{fileOps.current.getAppVersion()}</p>
          ...
          <p>Telegram: <a href='#' onClick={() => fileOps.current.openLink('https://t.me/substrate_ide')}>https://t.me/substrate_ide</a></p>
        </div>
      </Modal>
    )
  }
